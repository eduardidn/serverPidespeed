...
class Server {
    ...
    config() {
        ...
        this.app.use(cors_1.default({ origin: ['http://localhost:4200', 'http://pidespeed.com', 'http://empresas.pidespeed.com', 'http://test.pidespeed.com', 'http://gerencia.pidespeed.com', 'http://192.168.1.25:4200'] }));
