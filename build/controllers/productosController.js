...
class ProductosController {
    ...
    listCat(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (tipo == 2) {
                    const productos = yield db_1.default.query('SELECT categorias_product.* FROM categorias_product INNER JOIN empresas ON empresas.categoria_id = categorias_product.categoria_id WHERE empresas.ruta = ?', [ruta]);
                    res.json(productos);
                }
                else {
